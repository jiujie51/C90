...
EMB_PARTITION ind_emb_partition_info_data[EMB_PARTITION_INFO_COUNT] __attribute__((section("modelext_data.emb_partition_info"))) = {
	...
	#if defined(_DSP1_NONE_) //Kevin_mio, AV_LCA_FUNC == ENABLE
	...
	#else // ACTIVE if (AV_LCA_FUNC == ENABLE)
		
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00370000), BLK_UNIT(0x00040000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x003B0000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},
	#endif
