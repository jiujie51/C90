...
EMB_PARTITION ind_emb_partition_info_data[EMB_PARTITION_INFO_COUNT] __attribute__((section("modelext_data.emb_partition_info"))) = {
	...
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00370000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
	#if 0//defined(_DSP1_NONE_)
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x006A0000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x006A0000), BLK_UNIT(0x00160000), BLK_UNIT(0x00000000)},
	#endif
	#else
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x003F0000), BLK_UNIT(0x00100000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x004F0000), BLK_UNIT(0x00100000), BLK_UNIT(0x00000000)},
	#endif
	[7] = {EMBTYPE_USER0,   0,  BLK_UNIT(0x005F0000), BLK_UNIT(0x00200000), BLK_UNIT(0x00000000)},
	#endif
#else
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
