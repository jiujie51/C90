...
///* 0721
	NVTEVT_USER_CLICK                = 0x11060120, ///< Click control
	
	NVTEVT_USER_DOUBLECLICK          = 0x11060121, ///< Double click control
	NVTEVT_USER_SLIDE_LEFT           = 0x11060122, ///< Slide left for horizontalslide control
	NVTEVT_USER_SLIDE_RIGHT          = 0x11060123, ///< Slide right for horizontal slide control
	NVTEVT_USER_SLIDE_UP             = 0x11060124, ///< Slide up for vertical slide control
	NVTEVT_USER_SLIDE_DOWN           = 0x11060125, ///< Slide down for vertical slide control
	NVTEVT_USER_RELEASE              = 0x11060126,
	NVTEVT_USER_MOVE                 = 0x11060127,
	NVTEVT_USER_PRESS                = 0x11060128,
	//*/
...
typedef enum {
	...
	/* INSERT NEW EVENT HRER */
    NVTEVT_IGNORE_SLIDE_TOUCH_TIMER = 0x8000100b,

//#MT#lyb -20200331 -begin
    NVTEVT_LCA_ALARM_TIMER      = 0x8000100c,
//#MT#lyb -20200331 -end
NVTEVT_WIFI_UI_TIMER,
	// power event
...
//#MT#lyb -20200331 -begin
    NVTEVT_USER_LCA_RESULT      = 0x8000f020,
//#MT#lyb -20200331 -end
