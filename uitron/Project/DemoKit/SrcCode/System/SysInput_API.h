...
extern void  UI_CancelTouchEventMask(UINT32 event);
extern void  UI_SetTouchEventMask(UINT32 event);
extern BOOL  UI_DecideTouchEventMask(UINT32 event);
#endif

//#MT#lyb -20200403 -begin
extern BOOL bAccPowerOff;
extern BOOL System_GetGsensorPwrOn(void);
extern void System_SetGsensorPwrOn(BOOL bValue);
extern void System_DecParkPwroffTimeCount(void);
