...
//#NT#2016/03/23#Isiah Chang -begin
//#NT#add new Wi-Fi UI flow.
	if (strcmp(addr, "send SocketHB") == 0)
		{
		debug_msg("\r\n socket HB\r\n");
...
//WIFI_CMD_ITEM(WIFIAPP_CMD_ETHCAM_CHG, NVTEVT_WIFI_EXE_ETHCAM_CHG, 0, WIFIFLAG_ETHCAM_CHG_DONE, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_ETHCAM_STA , 0,  (UINT32)XML_GetEthStatus, 0, FL_NULL)
...
//#NT#2016/03/23#Isiah Chang -begin
//#NT#add new Wi-Fi UI flow.
#if 1//(WIFI_UI_FLOW_VER == WIFI_UI_VER_2_0)
