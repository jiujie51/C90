...
#define WIFIAPP_CMD_ETHCAM_STA    			  8007 // 2026
#define WIFIAPP_CMD_ETHCAM_CHG  			  2026
//setup command
...
#define WIFIFLAG_ETHCAM_CHG_DONE  	FLGPTN_BIT(7)

typedef enum{
	WIFI_APP_SET_FRONT =0,
	WIFI_APP_SET_BEHIND,
	ENUM_DUMMY4WORD(WIFI_APP_ETHCAM_CHG)
