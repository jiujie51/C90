...
{
    ROOTDIR_TYPE_MOVIE,
    ROOTDIR_TYPE_MOVIE_EMR,
    //ROOTDIR_TYPE_REAR_MOVIE,
    //ROOTDIR_TYPE_REAR_MOVIE_EMR,
    ROOTDIR_TYPE_TIMELAPSE_MOVIE,
    ROOTDIR_TYPE_PHOTO,
    ROOTDIR_TYPE_ALL
} UIPLAY_ROOTDIR_TYPE;
...
extern UIPLAY_ROOTDIR_TYPE UIPlay_GetRootDirType(void);
