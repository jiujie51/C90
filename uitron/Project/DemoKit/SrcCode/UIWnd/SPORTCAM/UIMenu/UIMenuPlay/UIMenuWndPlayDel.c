...
EVENT_ITEM(NVTEVT_CLICK , UIMenuWndPlayDel_Menu_OnKeyEnter)//NVTEVT_KEY_ENTER
...
INT32 UIMenuWndPlayDel_Menu_OnKeyEnter(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	...
	if ( ParamIn >0 )
	{
			Ux_OpenWindow((VControl *)(&UIMenuWndPlayConfirmDelCtrl), 2, curItem, ParamIn);
			return NVTEVT_CONSUME;
	}
