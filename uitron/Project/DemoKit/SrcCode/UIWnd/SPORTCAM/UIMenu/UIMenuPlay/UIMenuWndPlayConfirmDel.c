...
EVENT_ITEM(NVTEVT_KEY_NEXT , UIMenuWndPlayConfirmDel_Menu_OnKeyDown)//NVTEVT_KEY_NEXT
EVENT_ITEM(NVTEVT_CLICK, UIMenuWndPlayConfirmDel_Menu_OnKeyEnter)
EVENT_END
...
CHKPNT;
	...
	if (UxMenu_GetData(pCtrl, MNU_CURITM) == UIMenuWndPlayConfirmDel_Menu_STRID_OK) {
		...
		case UIMenuWndPlayConfirmDel_StatusText_STRID_ERASE_ALL:
			Ux_OpenWindow(&UIFlowWndWaitMomentCtrl, 2, UIFlowWndWaitMoment_StatusTXT_Msg_STRID_PLEASE_WAIT,0);
