...
CTRL_LIST_ITEM(UIMenuWndSetupDefaultSetting_Static_TxtTop)
CTRL_LIST_ITEM(UIMenuWndSetupDefaultSetting_Panel)
CTRL_LIST_END
...
//----------------------UIMenuWndSetupDefaultSetting_Static_TxtTopCtrl Event---------------------------
EVENT_BEGIN(UIMenuWndSetupDefaultSetting_Static_TxtTop)
EVENT_END

//---------------------UIMenuWndSetupDefaultSetting_PanelCtrl Control List---------------------------
CTRL_LIST_BEGIN(UIMenuWndSetupDefaultSetting_Panel)
CTRL_LIST_ITEM(UIMenuWndSetupDefaultSetting_Static_TxtTip)
CTRL_LIST_ITEM(UIMenuWndSetupDefaultSetting_Static_TxtReset)
CTRL_LIST_ITEM(UIMenuWndSetupDefaultSetting_BTN_OK)
CTRL_LIST_ITEM(UIMenuWndSetupDefaultSetting_BTN_Cancle)
CTRL_LIST_END

//----------------------UIMenuWndSetupDefaultSetting_PanelCtrl Event---------------------------
EVENT_BEGIN(UIMenuWndSetupDefaultSetting_Panel)
EVENT_END

//----------------------UIMenuWndSetupDefaultSetting_Static_TxtTipCtrl Event---------------------------
EVENT_BEGIN(UIMenuWndSetupDefaultSetting_Static_TxtTip)
EVENT_END

//----------------------UIMenuWndSetupDefaultSetting_Static_TxtResetCtrl Event---------------------------
EVENT_BEGIN(UIMenuWndSetupDefaultSetting_Static_TxtReset)
EVENT_END

//----------------------UIMenuWndSetupDefaultSetting_BTN_OKCtrl Event---------------------------
INT32 UIMenuWndSetupDefaultSetting_BTN_OK_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIMenuWndSetupDefaultSetting_BTN_OK)
EVENT_ITEM(NVTEVT_CLICK,UIMenuWndSetupDefaultSetting_BTN_OK_OnTouchPanelClick)
EVENT_END

INT32 UIMenuWndSetupDefaultSetting_BTN_OK_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    debug_err(("Reset default setting\n\r"));
    Ux_SendEvent(&UISetupObjCtrl, NVTEVT_EXE_SYSRESET, 0);
    Ux_CloseWindow(&UIMenuWndSetupDefaultSettingCtrl, 1,0);
    return NVTEVT_CONSUME;
}
//----------------------UIMenuWndSetupDefaultSetting_BTN_CancleCtrl Event---------------------------
INT32 UIMenuWndSetupDefaultSetting_BTN_Cancle_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIMenuWndSetupDefaultSetting_BTN_Cancle)
EVENT_ITEM(NVTEVT_CLICK,UIMenuWndSetupDefaultSetting_BTN_Cancle_OnTouchPanelClick)
EVENT_END

INT32 UIMenuWndSetupDefaultSetting_BTN_Cancle_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    Ux_CloseWindow(&UIMenuWndSetupDefaultSettingCtrl, 0);
    return NVTEVT_CONSUME;
}
