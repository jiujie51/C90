...
TMDEF_OPTION_TEXT_S(MOVIE_SIZE_DUAL_2560x1440P30_2560x1440P30,  TM_OPTION_NOT_SUPPORT)  /// QHD QHD
...
TMDEF_OPTION_TEXT_S(MOVIE_SIZE_DUAL_1920x1080P60_1920x1080P60,  TM_OPTION_NOT_SUPPORT)  /// FHDp60 FHDp60
...
TMDEF_OPTION_TEXT_S(MOVIE_SIZE_FRONT_1920x1080P120,             TM_OPTION_NOT_SUPPORT)  /// FHD P120
TMDEF_OPTION_TEXT_S(MOVIE_SIZE_FRONT_1920x1080P96,              TM_OPTION_NOT_SUPPORT)  /// FHD P96
#if( (_BOARD_DRAM_SIZE_ <= 0x08000000) && (((SENSOR_CAPS_COUNT & SENSOR_ON_MASK) + ETH_REARCAM_CAPS_COUNT) >= 2))
TMDEF_OPTION_TEXT_S(MOVIE_SIZE_FRONT_1920x1080P60,              TM_OPTION_NOT_SUPPORT)       /// FHD P60
#else
...
TMDEF_OPTION_TEXT_S(MOVIE_CYCLICREC_OFF, TM_OPTION_ENABLE)
...
TMDEF_OPTION_TEXT_S(MOVIE_CYCLICREC_10MIN, TM_OPTION_ENABLE)
TMDEF_END_OPTIONS()
#endif
