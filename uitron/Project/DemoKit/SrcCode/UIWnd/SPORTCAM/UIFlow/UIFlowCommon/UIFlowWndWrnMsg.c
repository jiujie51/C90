...
#endif
INT32 UIFlowWndWrnMsg_OnTouchRelease(VControl *, UINT32, UINT32 *);
...
#endif
//
EVENT_ITEM(NVTEVT_USER_RELEASE, UIFlowWndWrnMsg_OnTouchRelease)

EVENT_END

INT32 UIFlowWndWrnMsg_OnOpen(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	debug_msg("UIFlowWndWrnMsg: OnOpen\r\n");
	debug_msg("paramNum is %d \r\n",paramNum);
	if (paramNum > 0) {
		g_uiWrnMsgIssue = paramArray[0];
		debug_msg("UIFlowWndWrnMsg: Issue case = %d\r\n", g_uiWrnMsgIssue);
		if (paramNum > 1) {
			g_uiWrnMsgExpTime = paramArray[1];
			debug_msg("UIFlowWndWrnMsg: Exp time = %d\r\n", g_uiWrnMsgExpTime);
		}
	...
	debug_msg("UIFlowWndWrnMsg_OnOpen g_uiWrnMsgIssue = %d\n\r", g_uiWrnMsgIssue);
...
#endif
INT32 UIFlowWndWrnMsg_OnTouchRelease(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
CHKPNT;
#if 0
