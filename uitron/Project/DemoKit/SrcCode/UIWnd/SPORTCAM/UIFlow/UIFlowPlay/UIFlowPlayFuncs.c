...
#elif (FLOWPB_THUMB_MODE == FLOWPB_THUMB_MODE_2_7)
// For display size 320x240, 5x5 thumbnail mode
{
	{  115,  45, 140, 100}, {265,  45, 140, 100}, {415,  45, 140, 100}, {565, 45, 140, 100}, {715,  45, 140, 100},{ 865, 45, 140, 100}, {1015, 45, 140, 100}, 

	{  115, 155, 140, 100}, {265, 155, 140, 100}, {415, 155, 140, 100}, {565, 155, 140, 100}, {715, 155,140, 100},{  865, 155, 140, 100}, {1015, 155, 140, 100}, 
...
#elif (FLOWPB_THUMB_MODE == FLOWPB_THUMB_MODE_2_7)
			//Todo: fine tune 5x5 location
			ThumbCfg.wFirstHGap         = 114;
			ThumbCfg.wHGap              = 10;
			ThumbCfg.wLastHGap          = 114;
			ThumbCfg.wFirstVGap         = 44;
			ThumbCfg.wVGap              = 6;
			ThumbCfg.wLastVGap          = 10;
#endif
		}
	}
