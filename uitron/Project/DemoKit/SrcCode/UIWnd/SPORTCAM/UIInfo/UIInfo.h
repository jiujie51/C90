...
//#MT#lyb -20200409 -begin
    FL_MOVIE_CYCLIC_REC_MENU,  // Movie cyclic recording menu
//#MT#lyb -20200409 -end
	...
	FL_MOVIE_CODEC, 
	    FL_SENSOR1_DISP_OFFSET,
	FL_SENSOR2_DISP_OFFSET,
		FL_MOVIE_PARK,
		FL_MOVIE_BACKADJUST, 
		FL_MOVIE_BACKADJUST_MENU,
// movie codec index
	// Playback
	...
	FL_IMGDISP_POS_STEP_ID0,
    FL_IMGDISP_POS_STEP_ID1,

//#MT#lyb -20200328 -begin
    FL_VOLUME,
    FL_SCREENLIGHT,
    FL_ALARM_LCA,//AV_LCA_FUNC
//#MT#lyb -20200328 -end
#if(_ANFA_ADAS_MENU_)
	FL_ANFA_ADAS,
#endif
...
enum _MOVIE_CYCLICREC {
	...
	MOVIE_CYCLICREC_OFF,	//zjf 20201123 synchronize menu
...
enum{
	MOVIE_BACKADJUST_OFF,
	MOVIE_BACKADJUST_ON,
	MOVIE_BACKADJUST_ID_MAX,
};
//-----------------------------------------------------------------------------
// Date Format
//-----------------------------------------------------------------------------
