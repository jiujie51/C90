...
#endif
#if (AUDPROC_FUNC == ENABLE)
UINT32 POOL_ID_AUDPROC  = 0;
//UINT32 POOL_ID_AISPEECH = 0;
#endif
...
#endif
#if (AUDPROC_FUNC == ENABLE)
	OS_CONFIG_MEMPOOL(POOL_ID_AUDPROC,       POOL_SIZE_AUDPROC,         POOL_CNT_AUDPROC);           // logfile working buffer
//	OS_CONFIG_MEMPOOL(POOL_ID_AISPEECH,      POOL_SIZE_AISPEECH,        POOL_CNT_AISPEECH);           // wakeup for aispeech
#endif
