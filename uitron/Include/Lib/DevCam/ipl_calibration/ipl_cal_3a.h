...
typedef struct {
	...
	ER(*fp_convert_param)(IPL_PROC_ID id, CAL_AE_PARAM *ae_input_param, CAL_AE_PARAM *ae_output_param, CAL_AE_ADJ adjust, CAL_ITEM cal_item); // need to preset reference parameter first  , CAL_ITEM cal_item
